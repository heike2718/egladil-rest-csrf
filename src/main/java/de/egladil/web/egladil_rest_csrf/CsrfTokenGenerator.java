...
public class CsrfTokenGenerator {
     ...
     * @param secretKey byte[] this is an aplication specific secret that will be used to sign the token. Minimum length is 64 byte.
     * @return String
     */
    public String generateToken(String salt, byte[] secretKey) {
        ...
        String hmacHex = new HmacGenerator().generateHmac(messagePayload, HmacGenerator.HMAC_ALGORITHM, secretKey);
